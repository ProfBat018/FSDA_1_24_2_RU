...
namespace EfLinq.Data.Contexts;
...
public partial class LibraryContext : DbContext
{
    ...
    public virtual DbSet<CategoriedProduct> CategoriedProducts { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=STHQ011A-01;Initial Catalog=Library;User ID=admin;Password=admin;Trust Server Certificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CategoriedProduct>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CategoriedProduct");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Category__3214EC0765EF6526");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Product__3214EC0764870DA1");

            entity.ToTable("Product", tb => tb.HasTrigger("DontDeleteProduct"));
