create database Ecommerce_24_2;
...
BEGIN
    IF EXISTS (
        SELECT 1
        FROM inserted as i
                 LEFT JOIN Auth_24_2.dbo.Users as u ON i.UserNameRef = u.userName
        WHERE u.userName IS NULL
    )
        BEGIN
            RAISERROR('Ошибка целостности данных: UserID не существует в Users.', 16, 1);
